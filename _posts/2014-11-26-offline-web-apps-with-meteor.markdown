...
date: 2014-11-26 22:18:55 +0000
comments: true
---
This blog post was written for [Group Buddies Blog](http://blog.groupbuddies.com/posts/45-offline-web-apps-with-meteor).
...
If you don't know what Meteor is or how it works, I recommend that you take a look at the [meteor docs](http://docs.meteor.com/#/basic/) before moving forward.
...
AppCache stores all the application assets and allows a user to open them when there is no internet connection. For more details on AppCache I recommend [this guide](http://www.html5rocks.com/en/tutorials/appcache/beginner/).
